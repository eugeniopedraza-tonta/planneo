    ...
    <footer className="bg-[#111827] text-[#9CA3AF]">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-14">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10 md:gap-8">
          ...
          <div className="flex flex-col gap-3">
            <div className="flex items-center gap-2">
              <Logo />
              <span className="font-bold text-white text-lg">Planneo</span>
            </div>
            <p className="text-sm leading-relaxed max-w-xs">
              La plataforma #1 para contratar músicos en México.
            </p>
          </div>
        ...
        <div className="mt-8 flex flex-col sm:flex-row items-center justify-between gap-4">
          <p className="text-sm">© 2025 Planneo. Todos los derechos reservados.</p>
